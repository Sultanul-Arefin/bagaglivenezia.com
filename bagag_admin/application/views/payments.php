            ...
            <table border="1px solid red" id="example" class="display nowrap" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Payment Done at</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center"><?php echo $value->payment_id; ?></td>
                            <td align="center"><?php echo $last_id; ?></td>
                            <td align="center"><?php echo $value->txn_id; ?></td>
                            <td align="center"><?php echo $value->payment_gross ?></td>
                            <td align="center"><?php echo $value->currency_code; ?></td>
                            <td align="center"><?php echo $value->payment_status; ?></td>
                            <td align="center"><?php echo $value->payment_done_at; ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
