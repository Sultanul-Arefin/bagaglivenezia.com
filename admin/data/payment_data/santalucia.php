...
$result = mysqli_query($mysqli, 'SELECT * FROM products where location="Santa Lucia (Calle de la Misericordia 366b, 30121 Venezia)" ORDER BY id DESC');
                ...
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    <table width='100%' border=0>
            			...
            			while($res = mysqli_fetch_array($result)){
            				...
            				// echo "<td>".$res['id']."</td>";
            				echo "<td><a href=\"deleteorder_santalucia.php?id=$res[id]\"onClick=\"return confirm('Are you sure you want to cancel this booking?')\">Cancel</a></td>";
